-- OFF hosted-DB bug-fix patch (2026-09-16)
-- Paste into Supabase Dashboard SQL Editor and run.
-- Idempotent: safe to re-run.

-- 1. Privacy flags (migration 160003) so Profile Settings toggles exist
...
-- 2. Slim onboarding (migration 160006): fixes missing complete_profile 404
